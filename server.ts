  ...
  app.post('/api/properties', async (req, res) => {
    ...
    try {
      ...
      const newProperty: Property = {
        ...
        condition: (propertyData.condition !== undefined && propertyData.condition !== '') ? propertyData.condition : 'New',
        negotiable: propertyData.negotiable || (propertyData.isNegotiable ? 'Yes' : 'No'),
        isNegotiable: propertyData.negotiable === 'Yes' || propertyData.isNegotiable === true,
