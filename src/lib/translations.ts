...
export const staticTranslations: TranslationKey[] = [
  ...
  { key: "seller_information", en: "SELLER INFORMATION", om: "ODEEFFANNOO GURGURAA", am: "የሻጭ መረጃ", category: "ListingDetails" },
  { key: "verified_seller", en: "Verified Seller", om: "Gurguraa Mirkanaa'e", am: "የተረጋገጠ ሻጭ", category: "ListingDetails" },
  { key: "active_ads", en: "Active Ads", om: "Beeksisa Hojii Irra Jiru", am: "ነቁ ማስታወቂያዎች", category: "ListingDetails" },
  { key: "member_since", en: "Member Since", om: "Miseensa Taanne", am: "አባል ከሆነበት ጊዜ", category: "ListingDetails" },
  { key: "view_all_seller_ads", en: "View All Seller Ads", om: "Beeksisa Gurguraa Hunda Ilaali", am: "ሁሉንም የሻጭ ማስታወቂያዎች ይመልከቱ", category: "ListingDetails" },
  { key: "chat_with_seller", en: "Chat with Seller", om: "Gurguraa Waliin Haasa'i", am: "ከሻጩ ጋር ያውሩ", category: "ListingDetails" },
